...
class AESCipher:
    ...
    def cipher_block(self, s0, s=sbox, g0=galNI[0], g1=galNI[1]):
        ...
        se^=re
        sf^=rf
        for r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,ra,rb,rc,rd,re,rf in self._Nr:
    ...
    def decipher_block(self, s0, s=i_sbox, g0=galI[0], g1=galI[1], g2=galI[2], g3=galI[3]):
        s0,s1,s2,s3,s4,s5,s6,s7,s8,s9,sa,sb,sc,sd,se,sf=s0
        r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,ra,rb,rc,rd,re,rf = self._l16
        s0^=r0
        s1^=r1
